    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div style="display: flex; justify-content: space-between">
					...
					<a href="{{ route('kategori.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
										...
										<tr>
											...
											<td>
												<form action="{{ route('kategori.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('kategori.edit', $item->id) }}" class="btn btn-warning">
