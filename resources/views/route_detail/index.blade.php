    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div style="display: flex; justify-content: space-between">
					...
					<a href="{{ route('route-detail.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
								...
								<tbody>
									...
									@forelse ($data as $item)
										<tr>
											...
											<td>
												<form action="{{ route('route-detail.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('route-detail.edit', $item->id) }}" class="btn btn-warning">
