			...
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Form Visit</li>
							</ol>
						</nav>
					</div>
				...
				<div class="row">
					<div class="col-xl-10 mx-auto">
						<h6 class="mb-0 text-uppercase">Form Visit</h6>
						<hr/>
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										...
										<h5 class="mb-0 text-info">Data Visit</h5>
									</div>
									<hr/>
                      ...
                      <div class="col-sm-9">
                         <select name="tracking_id" class="form-select mb-3" aria-label="Default select example">
                          ...
                          @foreach ($tracking as $c)
                            <option @if(old('tracking_id') == $c->id) selected @endif value="{{ $c->id }}">{{ $c->act_date }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
