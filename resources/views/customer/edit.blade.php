				...
				<div class="row">
                  ...
                  <form action="{{ route('customer.update', $data->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="{{ old('name', $data->name) }}" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Nama Pelanggan...">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="{{ old('urban_village', $data->urban_village) }}" name="urban_village" class="form-control @error('urban_village') is-invalid @enderror" id="urban_village" placeholder="Kelurahan Pelanggan...">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="{{ old('sub_district', $data->sub_district) }}" name="sub_district" class="form-control @error('sub_district') is-invalid @enderror" id="sub_district" placeholder="Kecamatan Pelanggan...">
                      </div>
                    </div>
