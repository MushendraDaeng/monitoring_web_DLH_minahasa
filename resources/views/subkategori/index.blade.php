    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div style="display: flex; justify-content: space-between">
					<h6 class="mb-0 text-uppercase">Datatable Sub Kategori</h6>
					<a href="{{ route('sub-kategori.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
										...
										<tr>
											...
											<td>
												<form action="{{ route('sub-kategori.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('sub-kategori.edit', $item->id) }}" class="btn btn-warning">
