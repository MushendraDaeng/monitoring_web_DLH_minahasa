    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div style="display: flex; justify-content: space-between">
					<h6 class="mb-0 text-uppercase">Datatable Truck</h6>
					<a href="{{ route('truck.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
				...
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered" style="table-layout: fixed">
								<thead>
									<tr>
										<th>No</th>
										<th>Nama Truck</th>
										...
										<tr>
											...
											<td style="word-wrap: break-word">
												<form action="{{ route('truck.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('truck.edit', $item->id) }}" class="btn btn-warning">
													...
													<button type="button" 
														onclick="getElementById('gambarModal').src = `{{asset($item->foto != '' ? 'fto_truck/'.$item->foto : 'no-pictures.png')}}`" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModal">
				...
				<div class="modal-dialog modal-dialog-centered modal-lg">
					<div class="modal-content" >
						<div class="modal-header">
							<h5 class="modal-title">Foto Truck</h5>
