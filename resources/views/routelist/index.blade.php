    ...
    <div class="page-wrapper">
			<div class="page-content">
				...
				<div style="display: flex; justify-content: space-between">
					<h6 class="mb-0 text-uppercase">Datatable List Rute</h6>
					<a href="{{ route('routelist.create') }}" class="btn btn-success px-2" style="justify-content: space-between ">
								...
								<tbody>
									...
									@forelse ($data as $item)
										<tr>
											...
											<td>
												<form action="{{ route('routelist.destroy', $item->id) }}" method="post">
													@csrf
													@method('delete')
													<a id="berkasId" href="{{ route('routelist.show', $item->id) }}" class="btn btn-primary">
														<i class="fadeIn animated bx bx-detail me-0"></i>
													</a>
													<a id="berkasId" href="{{ route('routelist.edit', $item->id) }}" class="btn btn-warning">
